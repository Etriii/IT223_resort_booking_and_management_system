                    ...
                    <div className="w-full md:w-1/2 flex flex-col order-2 md:order-1">
                        ...
                        <img
                            ...
                            <span className="text-start">
                                ...
                                <p className="text-sm text-gray-900 mt-2 text-start">Price: ₱{room?.price_per_night}</p>
                                ...
                                <p className="text-sm text-gray-700 mt-2 mb-8 text-start">{room?.amenities}</p>
                                <hr className="w-full border-t border-neutral-300 my-2" />
                                <p className="text-lg font-medium text-gray-900 mt-3 text-start">Total Bill</p>
                                <p className="text-sm text-gray-700 mt-2 text-start">{room?.building_id}</p>
                            </span>
