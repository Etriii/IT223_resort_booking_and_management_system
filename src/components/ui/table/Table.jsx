...
const Table = ({ children, theadings, isLoading = false, containerRef }) => {
    ...
    const styles = {
        ...
        th: 'border px-3 py-2 text-sm font-semibold text-left whitespace-nowrap text-nowrap last:rounded-tr-sm first:rounded-tl-sm first:w-18 text-left first:text-center last:text-center last:w-12',
        tbody: '',
        row: '',
        col: '',
    };
